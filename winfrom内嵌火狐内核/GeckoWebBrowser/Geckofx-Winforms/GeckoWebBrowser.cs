    ...
    //nsIWindowProvider,
    {
        ...
        public GeckoWindow Window
        {
            get
            {
                ...
                _Window = Gecko.Interop.ExtensionMethods.Wrap(WebBrowser.GetContentDOMWindowAttribute(), x => new GeckoWindow(x));
                return _Window;
            }
        }
        ...
        public GeckoDomDocument DomDocument
        {
            get
            {
                if (WebBrowser == null)
                    return null;
                var domDocument = Gecko.Interop.ExtensionMethods.AsComPtr(new WebIDL.Window(Window.DomWindow, (nsISupports)Window.DomWindow).Document);
...
#warning when geckoFX is used in WPF application there are no forms. We should rewrite this code
            ...
            int aStatus)
        {
            ...
            using (var request = Gecko.Net.Request.CreateRequest(aRequest))
            {
                ...
                var domWindow = Gecko.Interop.ExtensionMethods.Wrap(aWebProgress.GetDOMWindowAttribute(), x => new GeckoWindow(x));
                            ...
                            try
                            {
                                ...
                                if (aChannel != null)
                                {
                                    ...
                                    if (aSecInfo != null)
                                    {
                                        ...
                                        {
                                            sslStatus = Gecko.Interop.ExtensionMethods.Wrap(aSslStatusProv.GetSSLStatusAttribute(), SSLStatus.Create);
                                        }
                                    }
                                }
                            }
            ...
            uint flags)
        {
            ...
            using (var domWindow = Gecko.Interop.ExtensionMethods.Wrap(aWebProgress.GetDOMWindowAttribute(), x => new GeckoWindow(x)))
            {
