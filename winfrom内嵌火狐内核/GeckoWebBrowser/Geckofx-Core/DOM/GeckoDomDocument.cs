...
namespace Gecko
{
        ...
        : GeckoNode
    {
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domDocument.GetDoctypeAttribute(), DomDocumentType.Create); }
        }
        ...
        public GeckoElement DocumentElement
        {
            get
            {
                ...
                return Gecko.Interop.ExtensionMethods.Wrap(domElement, GeckoElement.CreateDomElementWrapper);
            }
        }
        ...
        public GeckoElement CreateElement(string tagName)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMElement>(_domDocument.CreateElement, tagName), GeckoElement.CreateDomElementWrapper);
        }

        public DocumentFragment CreateDocumentFragment()
        {
            return Gecko.Interop.ExtensionMethods.Wrap(_domDocument.CreateDocumentFragment(), DocumentFragment.CreateDocumentFragmentWrapper);
        }

        public GeckoTextNode CreateTextNode(string data)
        {
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMText>(_domDocument.CreateTextNode, data), DOM.GeckoTextNode.CreateTextNodeWrapper);
        }

        public GeckoComment CreateComment(string data)
        {
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMComment>(_domDocument.CreateComment, data), GeckoComment.CreateCommentWrapper);
        }
        ...
        public GeckoAttribute CreateAttribute(string name)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMAttr>(_domDocument.CreateAttribute, name), GeckoAttribute.CreateAttributeWrapper);
        }
        ...
        public GeckoElementCollection GetElementsByTagName(string tagName)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMNodeList>(_domDocument.GetElementsByTagName, tagName), x => new GeckoElementCollection(x));
        }
        ...
        public GeckoAttribute CreateAttribute(string namespaceUri, string qualifiedName)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMAttr>(_domDocument.CreateAttributeNS, namespaceUri, qualifiedName),
        ...
        public DomEventArgs CreateEvent(string name)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(target, DomEventArgs.Create);
        }
        ...
        public GeckoElement GetElementById(string id)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMElement>(_domDocument.GetElementById, id),
        ...
        public GeckoHtmlElement GetHtmlElementById(string id)
        {
            ...
            return (GeckoHtmlElement)Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMElement>(_domDocument.GetElementById, id), Create);
        }
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domDocument.GetDefaultViewAttribute(), x => new GeckoWindow(x)); }
        }
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domDocument.GetLocationAttribute(), Location.Create); }
        }
        ...
        {
            get { return (GeckoHtmlElement)Gecko.Interop.ExtensionMethods.Wrap(_domDocument.GetActiveElementAttribute(), Create); }
        }
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domDocument.GetCurrentScriptAttribute(), Create); }
        }
