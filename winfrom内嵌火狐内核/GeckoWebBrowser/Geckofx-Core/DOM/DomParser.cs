...
namespace Gecko.DOM
{
    public sealed class DomParser
    {
        ...
        {
            return Gecko.Interop.ExtensionMethods.Wrap(_domParser.Instance.ParseFromString(str, contentType), GeckoDomDocument.CreateDomDocumentWraper);
        }
        ...
        {
            return
                Gecko.Interop.ExtensionMethods.Wrap(_domParser.Instance.ParseFromBuffer(buffer, (uint)count, contentType), GeckoDomDocument.CreateDomDocumentWraper);
        }
        ...
        {
            return Gecko.Interop.ExtensionMethods.Wrap(_domParser.Instance.ParseFromBuffer(buffer, (uint)buffer.Length, contentType),
