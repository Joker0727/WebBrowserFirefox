...
namespace Gecko.DOM
{
    public sealed class DomEventTarget
    {
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_target.Instance.GetTargetForDOMEvent(), Create); }
        }
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_target.Instance.GetTargetForEventTargetChain(), Create); }
        }
    }
}