...
namespace Gecko
{
        ...
        : EventArgs
    {
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_event.GetCurrentTargetAttribute(), DOM.DomEventTarget.Create); }
        }
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_event.GetTargetAttribute(), DOM.DomEventTarget.Create); }
        }
