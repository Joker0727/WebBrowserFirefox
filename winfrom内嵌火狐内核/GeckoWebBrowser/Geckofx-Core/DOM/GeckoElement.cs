...
namespace Gecko
{
        ...
        : GeckoNode
    {
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domElement.GetAttributesAttribute(), x => new GeckoNamedNodeMap(x)); }
        }
        ...
        public IDomHtmlCollection<GeckoElement> GetElementsByTagName(string tagName)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMHTMLCollection>(_domElement.GetElementsByTagName, tagName),
                x => new DomHtmlCollection<GeckoElement, nsIDOMHTMLElement>(x, CreateDomElementWrapper));
        }
        ...
        public IDomHtmlCollection<GeckoElement> GetElementsByTagNameNS(string namespaceURI, string localName)
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass<nsIDOMHTMLCollection>(_domElement.GetElementsByTagNameNS, namespaceURI, localName)
                    , x => new DomHtmlCollection<GeckoElement, nsIDOMHTMLElement>(x, CreateDomElementWrapper));
        }
        ...
        {
            return Gecko.Interop.ExtensionMethods.Wrap(nsString.Pass(_domElement.QuerySelector, selectors), CreateDomElementWrapper);
        }
    }
}