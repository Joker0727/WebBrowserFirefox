...
namespace Gecko
{
        ...
        : IDisposable
    {
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domNode.Instance.GetChildNodesAttribute(), GeckoNodeCollection.Create); }
        }

        public GeckoNode FirstChild
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domNode.Instance.GetFirstChildAttribute(), Create); }
        }

        public GeckoNode LastChild
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domNode.Instance.GetLastChildAttribute(), Create); }
        }

        public GeckoNode NextSibling
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domNode.Instance.GetNextSiblingAttribute(), Create); }
        }

        public GeckoNode PreviousSibling
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domNode.Instance.GetPreviousSiblingAttribute(), Create); }
        }
        ...
        {
            get { return Gecko.Interop.ExtensionMethods.Wrap(_domNode.Instance.GetParentNodeAttribute(), Create); }
        }
        ...
        public GeckoElement ParentElement
        {
            get
            {
                ...
                return Gecko.Interop.ExtensionMethods.Wrap(((nsIDOMElement)node), GeckoElement.CreateDomElementWrapper);
            }
        }
        ...
        public GeckoNode SelectFirst(string xpath)
        {
            ...
            using (var context = new AutoJSContext())
            {
                ...
                var ret = Gecko.Interop.ExtensionMethods.Wrap(singleNode, GeckoNode.Create);
        ...
        public DomEventTarget GetEventTarget()
        {
            ...
            return Gecko.Interop.ExtensionMethods.Wrap(eventTarget, DomEventTarget.Create);
        }
    }
}