...
namespace Gecko.Interop
{
    public static class ExtensionMethods
    {
        ...
        /// <returns></returns>
        public static TWrapper Wrap<TGeckoObject, TWrapper>(TGeckoObject obj, Func<TGeckoObject, TWrapper> wrapper)
        ...
        /// <param name="wrapper"></param>
        /// <returns></returns>
        public static TWrapper Wrap<TGeckoObject1, TGeckoObject2, TWrapper>(TGeckoObject1 obj,
        ...
        public static ComPtr<TCOMObject> AsComPtr<TCOMObject>(TCOMObject obj)
