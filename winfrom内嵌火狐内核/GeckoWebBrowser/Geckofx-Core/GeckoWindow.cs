        ...
        : IEquatable<GeckoWindow>, IDisposable
    {
        ...
        public WindowUtils WindowUtils
        {
            get
            {
                ...
                return Gecko.Interop.ExtensionMethods.Wrap(utils, WindowUtils.Create);
            }
        }
        ...
        public GeckoDomDocument Document
        {
            ...
            {
                return
                    Gecko.Interop.ExtensionMethods.Wrap(new WebIDL.Window(_domWindow.Instance, (nsISupports)_domWindow.Instance).Document,
        ...
        public GeckoWindow Parent
        {
            get
            {
                return Gecko.Interop.ExtensionMethods.Wrap(new WebIDL.Window(_domWindow.Instance, (nsISupports)_domWindow.Instance).Parent,
                    x => new GeckoWindow(x));
            }
        }
        ...
        public GeckoWindow Top
        {
            ...
            {
                return
                    Gecko.Interop.ExtensionMethods.Wrap(new WebIDL.Window(_domWindow.Instance, (nsISupports)_domWindow.Instance).Top, x => new GeckoWindow(x));
            }
        }
