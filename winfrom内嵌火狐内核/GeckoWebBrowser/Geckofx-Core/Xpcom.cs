    ...
    public static class Xpcom
    {
        ...
        public static ComPtr<nsIXPConnect> XPConnect
        {
            get
            {
                ...
                return _xpconnectComPtr ?? (_xpconnectComPtr = Gecko.Interop.ExtensionMethods.AsComPtr(GetService<nsIXPConnect>("@mozilla.org/js/xpc/XPConnect;1")));
            }
        }
        ...
        public static TInterfaceType GetInterface<TInterfaceType>(nsIInterfaceRequestor requestor)
        {
