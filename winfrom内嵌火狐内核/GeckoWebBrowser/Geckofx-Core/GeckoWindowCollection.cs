    ...
    public class GeckoWindowCollection : IEnumerable<GeckoWindow>
    {
        ...
        public virtual GeckoWindow this[uint index]
        {
            get
            {
                ...
                return Gecko.Interop.ExtensionMethods.Wrap(_collection.Instance.Item(index), x => new GeckoWindow(x));
            }
        }
        ...
        public virtual IEnumerator<GeckoWindow> GetEnumerator()
        {
            ...
            {
                yield return Gecko.Interop.ExtensionMethods.Wrap(_collection.Instance.Item(i), x => new GeckoWindow(x));
            }
        }
